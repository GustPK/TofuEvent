...
- TofuApplication/
  - TOFU(PDf)
  - tofu-application-mac
  - tofu-application-win
...
####  - หน้าที่ที่รับผิดชอบในความคืบหน้าครั้งที่ 3
...
####  - หน้าที่ที่รับผิดชอบในความคืบหน้าครั้งที่ 4
...
- 21.b มีหน้าแสดง และ หน้าจัดการ (เพิ่มและลบ)  “ตารางกิจกรรมของอีเวนต์สำหรับผู้ร่วมทีม<ชื่อทีม>”
- 21.c ผู้จัดอีเวนต์กำหนดได้ว่า กิจกรรมใดเสร็จสิ้นไปแล้ว
- 22.a ผู้เข้าทีมเห็นชื่อทีม และ “ตารางกิจกรรมของอีเวนต์สำหรับผู้ร่วมทีม<ชื่อทีม>” สามารถแสดงความคิดเห็นภายในกิจกรรม และ สามารถดูความคิดเห็นภายในกิจกรรมและโต้ตอบกันได้ ความคืบหน้าครั้งที่ 4
####  - หน้าที่ที่รับผิดชอบในความคืบหน้าครั้งที่ 4
-  9.a ระบุวิธีการใช้งานเพื่ออธิบายวิธีการใช้งานโปรแกรม
-  9.b ระบุตัวอย่างข้อมูลของ Username และ Password ในการเข้าใช้งานระบบของแต่ละ role
-  9.c ระบุรายละเอียด CSV
